...
import ChangeRequestForm from './Wrapper.js';
...
const AttendaceChangeRequest = ({ navigation }) => {
    ...
    const [routes] = React.useState([
        { key: 'first', title: "Attendance Change Request" },
    ...
    const RenderScene = (e, navigation) => {
        ...
        switch (e.route.key) {
            case 'first':
                return <ChangeRequestForm navigation={navigation} />;
    ...
    return (
        <SafeAreaView style={Theme.SafeArea}>
            <GeneralHeader title={'Change Attendance'} navigation={navigation} />
